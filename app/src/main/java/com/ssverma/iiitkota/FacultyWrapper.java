...
public class FacultyWrapper {
    ...
    public String getFaculty_imageLink() {
        return faculty_imageLink;
    }

    public void setFaculty_imageLink(String faculty_imageLink) {
        this.faculty_imageLink = faculty_imageLink;
    }
