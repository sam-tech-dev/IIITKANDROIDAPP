...
public class Academic_Home extends AppCompatActivity implements Academic_Home_Adapter.RCVClickListener {
    ...
    private String[] icon_names = {"Academic Timetable", "Academic Calendar", "Curricula and Syllabi", "Academic Resources", "Sponsored Research", "Fee Structure"};
    private int[] icons = {R.drawable.academic_timetable_icon, R.drawable.academic_calender_icon,
            R.drawable.academic_courses_icon, R.drawable.academic_resources_icon, R.drawable.academic_research_icon, R.drawable.academic_fee_structure_icon};
    ...
    public void onRCVClick(View v, int position) {
        switch (position) {
            ...
            case 4:
                ...
                break;
            case 5:
                startActivity(new Intent(this, Academic_Fee_Structure.class));
                break;
        }
    }
}
